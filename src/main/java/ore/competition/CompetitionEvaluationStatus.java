...
public class CompetitionEvaluationStatus {
	...
	protected ore.competition.CompetitionEvaluationType mEvaluationType = null;
	...
	public CompetitionEvaluationStatus(String competitionName, String competitionSourceString, String evaluationName, String evaluationSourceString, ore.competition.CompetitionEvaluationType evaluationType, DateTime timeStamp) {
	...
	public CompetitionEvaluationStatus(Competition competition, String evaluationName, String evaluationSourceString, ore.competition.CompetitionEvaluationType evaluationType, DateTime timeStamp) {
	...
	public ore.competition.CompetitionEvaluationType getEvaluationType() {
