	...
	public static void main(String[] args) {
		...
		for (String ontologyFileString : sortedOntologyFileStringCollection) {
			...
			if (ontologyFileString.startsWith("ore2014")) {
				...
				QueryExpressivity queryExpressivity = new ore.generation.OntologyExpressivityChecker(ontologyFilePathString.getAbsoluteFilePathString()).createQueryExpressivity();
				...
				if (validOntology) {
					...
					if (generateRealisation) {
						...
						ore.generation.OntologyExpressivityChecker ontExpChecker = new ore.generation.OntologyExpressivityChecker(ontologyFilePathString.getAbsoluteFilePathString());
